...
public class LineTest {
    ...
    @Test
    public void scoreWinningLineForAI() {
        Line line = new Line(Arrays.asList(Counter.X, Counter.X, Counter.X));
        assertEquals((Integer) 100, line.score(Counter.X));
    }

    @Test
    public void scoreOneInLineForAI() {
        Line line = new Line(Arrays.asList(Counter.X, Counter.EMPTY, Counter.EMPTY));
        assertEquals((Integer) 1, line.score(Counter.X));
    }

    @Test
    public void scoreTwoInLineForAI() {
        Line line = new Line(Arrays.asList(Counter.X, Counter.X, Counter.EMPTY));
        assertEquals((Integer) 10, line.score(Counter.X));
    }

    @Test
    public void scoreWinningLineForOpponent() {
        Line line = new Line(Arrays.asList(Counter.X, Counter.X, Counter.X));
        assertEquals(new Integer(-100), line.score(Counter.O));
    }

    @Test
    public void scoreOneInLineForOpponent() {
        Line line = new Line(Arrays.asList(Counter.X, Counter.EMPTY, Counter.EMPTY));
        assertEquals(new Integer(-1), line.score(Counter.O));
    }

    @Test
    public void scoreTwoInLineForOpponent() {
        Line line = new Line(Arrays.asList(Counter.X, Counter.X, Counter.EMPTY));
        assertEquals(new Integer(-10), line.score(Counter.O));
    }

    @Test
    public void scoreWhenLineHasBothCounters() {
        Line line = new Line(Arrays.asList(Counter.X, Counter.O, Counter.EMPTY));
        assertEquals(new Integer(0), line.score(Counter.O));
    }

    @Test
    public void scoreWhenNoCounters() {
        Line line = new Line(Arrays.asList(Counter.EMPTY, Counter.EMPTY, Counter.EMPTY));
        assertEquals(new Integer(0), line.score(Counter.O));
    }
}
